...
OTHER_FILES += \
        $$PWD/qmlscreenextras.qdocconf \
        $$PWD/src/qml-qmlscreenextras.qdoc \
        $$PWD/docs.pri
...
qt:greaterThan(QT_MAJOR_VERSION, 4) {
    ...
    QDOC_MAINFILE = $$PWD/qmlscreenextras.qdocconf
} else {
...
## for release
## HTML_DOC_PATH=$$[QT_INSTALL_DOCS]/qmlscreenextras/
...
QHP_FILE = $$HTML_DOC_PATH/qmlscreenextras.qhp
QCH_FILE = $$OUT_PWD/doc/qmlscreenextras.qch
...
inst_html_docs.path = $$[QT_INSTALL_DOCS]/qmlscreenextras/
...
all_examples.files += $$PWD/../examples/qmlscreenextras/*

all_examples.path = $$[QT_INSTALL_EXAMPLES]/qmlscreenextras/
